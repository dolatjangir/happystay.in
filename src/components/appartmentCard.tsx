...
import { MapPin, Star, Heart, Users, BedDouble, Bath, Sofa } from "lucide-react";
    ...
    >
      ...
      <div className="relative h-52 w-full overflow-hidden">
        ...
        {apartment.furnishing && (
          ...
          >
            <Sofa className="w-3 h-3" style={{ color: "var(--color-brand-600)" }} />
            {apartment.furnishing}
          </span>
        )}
        ...
        {apartment.badge && (
          <span
            className="absolute top-3 right-11 text-white text-[11px] font-semibold px-2.5 py-1 rounded-full shadow-sm"
            style={{ backgroundColor: apartment.badgeColor ?? "var(--color-badge-favorite)" }}
          >
            {apartment.badge}
          </span>
        )}
      ...
      <div className="flex flex-col flex-1 p-5 pt-6">
        ...
        {(apartment.guests || apartment.bedrooms || apartment.bathrooms) && (
          <div
        ...
        <div className="mt-auto pt-4 flex items-center justify-between">
          <div>
            ...
            <span className="text-xs font-medium ml-1" style={{ color: "var(--color-text-faint)" }}>
              / {apartment.priceUnit ?? "night"}
            </span>
            <p className="text-[11px]" style={{ color: "var(--color-text-faint)" }}>
              {apartment.reviewsCount} reviews
            </p>
          </div>
